...
var throttle_1 = __importDefault(require("../../util/throttle"));
var creator_1 = require("../Icon/creator");
...
var MassLayer = /** @class */ (function (_super) {
    ...
    function MassLayer(options) {
        ...
        _this.getIconUrl = function (point) { return point.iconUrl || _this.options.iconUrl || creator_1.defaultOptions.iconUrl; };
        ...
        _this.onMouseMove = function (e) {
            ...
            if (points && points.length) {
                ...
                if (target) {
                    leaflet_1.default.DomUtil.addClass(_this.canvas, 'leaflet-interactive');
        ...
        _this.reset = function () {
            ...
            var point = leaflet_1.default.DomUtil.getPosition(_this._map.getPanes().mapPane);
            leaflet_1.default.DomUtil.setPosition(_this.canvas, leaflet_1.default.point(-Math.round(point.x), -Math.round(point.y)));
            _this.draw();
        };
        _this.zoomAnim = function (e) {
            var scale = _this._map.getZoomScale(e.zoom, _this._map.getZoom());
            var position = leaflet_1.default.DomUtil.getPosition(_this.canvas);
            ...
            leaflet_1.default.DomUtil.setTransform(_this.canvas, topLeftOffset, scale);
        };
        _this.onPopupClose = function () { _this.click = undefined; };
        leaflet_1.default.Util.setOptions(_this, leaflet_1.default.Util.extend(exports.defaultOptions, options));
        _this.canvas = leaflet_1.default.DomUtil.create('canvas', 'leaflet-zoom-animated');
    ...
    MassLayer.prototype.setThrottledReset = function (options) {
        var threshold = options.throttleThreshold || exports.defaultOptions.throttleThreshold;
        var duration = options.throttleDuration || exports.defaultOptions.throttleDuration;
        this.throttledReset = options.points.length <= threshold ? this.reset : throttle_1.default(this.reset, duration);
    };
    ...
    MassLayer.prototype.onRemove = function (map) {
        ...
        this.off();
        leaflet_1.default.DomUtil.remove(this.canvas);
        return this;
    };
    ...
    MassLayer.prototype.getIconSize = function (point) {
        ...
        if (iconSize) {
            return leaflet_1.default.point(iconSize);
        }
        var iconUrl = this.getIconUrl(point);
        if (iconUrl === creator_1.defaultOptions.iconUrl) {
            return leaflet_1.default.point(creator_1.defaultOptions.iconSize);
        }
        var icon = this.icons[iconUrl];
        return leaflet_1.default.point(icon.width, icon.height);
    };
    ...
    MassLayer.prototype.getIconAnchor = function (point) {
        ...
        if (iconAnchor) {
            return leaflet_1.default.point(iconAnchor);
        }
        if (this.getIconUrl(point) === creator_1.defaultOptions.iconUrl) {
            return leaflet_1.default.point(creator_1.defaultOptions.iconAnchor);
        }
        return leaflet_1.default.point(0, 0);
    };
    ...
    MassLayer.prototype.getPopupAnchor = function (point) {
        ...
        if (popupAnchor) {
            return leaflet_1.default.point(popupAnchor);
        }
        if (this.getIconUrl(point) === creator_1.defaultOptions.iconUrl) {
            return leaflet_1.default.point(creator_1.defaultOptions.popupAnchor);
        }
        return leaflet_1.default.point(0, 0);
    };
    ...
    MassLayer.prototype.getTooltipAnchor = function (point) {
        ...
        if (tooltipAnchor) {
            return leaflet_1.default.point(tooltipAnchor);
        }
        if (this.getIconUrl(point) === creator_1.defaultOptions.iconUrl) {
            return leaflet_1.default.point(creator_1.defaultOptions.tooltipAnchor);
        }
        return leaflet_1.default.point(0, 0);
    };
    ...
    MassLayer.prototype.prepareIcons = function () {
        ...
        if (points && points.length) {
            this.icons = {};
            var urls = Array_1.distinct(points.map(this.getIconUrl));
    ...
    return MassLayer;
}(leaflet_1.default.Layer));
exports.default = MassLayer;
