...
var ImageOverlay = /** @class */ (function (_super) {
    ...
    ImageOverlay.prototype.createInstance = function (props) {
        var url = props.url, bounds = props.bounds, options = __rest(props, ["url", "bounds"]);
        return leaflet_1.default.imageOverlay(url, bounds, options);
    };
    ImageOverlay.propTypes = __assign({}, Class_1.default.propTypes, { url: prop_types_1.default.string.isRequired });
    return ImageOverlay;
}(Class_1.default));
