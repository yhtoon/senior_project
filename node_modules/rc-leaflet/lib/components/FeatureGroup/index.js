...
var FeatureGroup = /** @class */ (function (_super) {
    ...
    FeatureGroup.prototype.createInstance = function (props) {
        return leaflet_1.default.featureGroup();
    };
    ...
    FeatureGroup.prototype.render = function () {
        ...
        return children ? react_1.Children.map(children, function (child) { return (react_1.isValidElement(child) ? react_1.cloneElement(child, __assign({ zIndex: zIndex, zIndexOffset: zIndex }, _this.theme, _this.pathOptions, child.props, { group: group, layer: group })) : child); }) : null;
    };
    return FeatureGroup;
}(LayerGroup_1.default));
