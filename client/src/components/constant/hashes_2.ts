export const OfficeMap = new Map<string, string>([['House', 'H'], ['President', 'P'], ['Senate', 'S']]);

export const StateMap = new Map<string, string>([[ 'Alabama', 'AL'], ['Alaska', 'AK'], ['Arizona', 'AZ'], ['Arkansas', 'AR'], ['American Samoa', 'AS'],
...
export const CandIciMap = new Map<string, string>([['Challenger', 'C'], ['Incumbent', 'I'], ['Open Seat', 'O']]);

export const PartyMap = new Map<string, string>([['Ace Party', 'ACE'], ['Alaskan Independence Party', 'AKI'], ['American Independence Conservative', 'AIC'],
